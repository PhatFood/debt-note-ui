...
import {getLeadsContent} from "./contactSlice"
...
function Contacts() {
    ...
    return (
        <>
            ...
            <TitleCard title="Contacts" topMargin="mt-2" TopSideButtons={<TopSideButtons/>}>
                                    ...
                                    <tr key={k}>
                                        ...
                                        <td>
                                            <button className="btn btn-square btn-ghost"
                                                    onClick={() => deleteCurrentLead(k)}><TrashIcon className="w-5"/>
                                            </button>
                                        </td>
                                    </tr>
                                )
